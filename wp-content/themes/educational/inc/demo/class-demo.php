...
if ( ! class_exists( 'Educational_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Educational_Demo {

		/**
		 * Singleton instance of Educational_Demo.
		 *
		 * @var Educational_Demo $instance Educational_Demo instance.
		 */
		...
		/**
		 * Main Educational_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Educational_Demo ) ) {
				self::$instance = new Educational_Demo();
